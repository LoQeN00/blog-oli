...
export type ScheduledOperationAffectedDocument = Account | Asset | Author | Page | Post | Seo;
...
export type CreateAccountMutation = { __typename?: 'Mutation', createAccount?: { __typename?: 'Account', id: string } | null, publishAccount?: { __typename?: 'Account', id: string } | null };

export type GetAllPostsListQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllPostsListQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', id: string, slug: string, title: string, date: any, excerpt?: string | null, coverImage?: { __typename?: 'Asset', url: string } | null, author?: { __typename?: 'Author', id: string, name: string } | null }> };

export type GetPostsSlugsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetPostsSlugsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', slug: string }> };
...
/**
 * __useGetAllPostsListQuery__
 *
 * To run a query within a React component, call `useGetAllPostsListQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAllPostsListQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAllPostsListQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetAllPostsListQuery(baseOptions?: Apollo.QueryHookOptions<GetAllPostsListQuery, GetAllPostsListQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAllPostsListQuery, GetAllPostsListQueryVariables>(GetAllPostsListDocument, options);
      }
export function useGetAllPostsListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAllPostsListQuery, GetAllPostsListQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAllPostsListQuery, GetAllPostsListQueryVariables>(GetAllPostsListDocument, options);
        }
export type GetAllPostsListQueryHookResult = ReturnType<typeof useGetAllPostsListQuery>;
export type GetAllPostsListLazyQueryHookResult = ReturnType<typeof useGetAllPostsListLazyQuery>;
export type GetAllPostsListQueryResult = Apollo.QueryResult<GetAllPostsListQuery, GetAllPostsListQueryVariables>;
